...
Get started downloading the CERN evaluation datasets by running:
...
If you want to train your own HMM models, you will need to prepare the training dataset as well:
