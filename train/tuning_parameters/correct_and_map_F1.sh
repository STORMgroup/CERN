...
"$CERN_PATH" "$MODEL" "${DATA_DIR}/d1_ecoli_training_${SEGMENTER}_events.tsv" "$PSTAY" "$PSKIP" --window-size "${WINDOWSIZE}" > "${DATA_DIR}/d1_ecoli_training_${SEGMENTER}_events_corrected_${RUN_ID}.tsv"
