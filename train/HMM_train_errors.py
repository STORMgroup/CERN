...
STARTING_HMM = "hmm_196_10_phase2.txt"             # HMM to load in
EVENT_FILE = "../test/data/cern_datasets/CERN_data/d1_ecoli_training/d1_ecoli_training_scrappieR9_events.tsv"    # File to load real segmented nanopore data from
HMM_FILENAME = "hmm_196_scrapR9_new.txt"          # File to save HMM to
